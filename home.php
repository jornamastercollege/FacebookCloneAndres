    ...
    <div class="row">
      <div class="col-md-3">
        ...
        <div class="panel panel-default">
          <div class="panel-body">
            <h4>dedeelnemernieuw</h4>
            <p>Leuk om mee te doen!</p>
          </div>
        </div>
        <!-- ./profile brief -->
      ...
      <div class="col-md-6">
        ...
        <div>
          ...
          <div class="panel panel-default">
            <div class="panel-body">
              <p>Beste deelnemers. Dit is een eerste FaceClone bericht. </p>
            </div>
            <div class="panel-footer">
              <span>posted 2017-5-27 20:45:01 door dewebmeester</span> 
